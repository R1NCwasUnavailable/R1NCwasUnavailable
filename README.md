...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=30&duration=2800&pause=800&color=58A6FF&center=true&vCenter=true&width=700&lines=hey%2C+I'm+Prince+%F0%9F%91%8B;ML+Engineer+%2B+Backend+Dev;building+production-ready+systems)](https://git.io/typing-svg)

<p>
  <b>CS undergrad @ KIIT</b> · ML systems · backend engineering <br/>
  focused on <b>production-ready ML</b>, APIs, and scalable systems
</p>
...
- building **end-to-end ML systems** (not just notebooks → APIs + deployment)
- learning **model serving + MLOps pipelines**
- improving **backend + DevOps** (Docker, CI/CD, cloud)
- open to **SWE / ML / backend internships (PPO-focused)**
